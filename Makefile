...
ifeq ($(OS), Windows_NT)
	...
	LFLAGS = -LC:/mingwdev/lib -LC:/mingwdev/opengl/lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_net -lopengl32 -lglew32 -o $(OUT)
	...
	LFLAGS = -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL_net -lGLEW -lGL -lGLU -lm -o $(OUT)
endif
